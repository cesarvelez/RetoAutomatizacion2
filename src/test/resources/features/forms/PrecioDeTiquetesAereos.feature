...
Feature: Buscar los 10 precios más baratos de tiquetes en el siguiente enlace
  ...
  Scenario Outline: Buscar los 10 precios más baratos de tiquetes aereos.
    ...
    Then verifico los precios de los vuelos
      | <orientacionCaso> | <resultadoEsperado> |

    Examples: 
      | origen   | destino   | fecha de partida | fecha regreso | numero de Viajeros | orientacionCaso | resultadoEsperado |
      | Medellin | Cartagena | 01/09/2018       | 29/09/2018    |                  2 | Acierto         | Precio final      |
